...
const LandingPage = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="w-full h-screen bg-[#FFFCEF] relative overflow-hidden">
        {/* background blur */}
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
          {/* Header */}
          <header className="w-full flex justify-between items-center absolute top-6 left-0 px-4">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="max-w-xl text-[17px] text-gray-900 mb-6">
